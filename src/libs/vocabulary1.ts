...
const vocabularyArray2: Vocabulary[] = [
  ...
  { label: 'relax', bold: true, explain: 'vt 使放松' },
  { label: 'ease', bold: false, explain: 'v.缓解 放松' },
  { label: 'rest', bold: false, explain: 'n.休息' },
  ...
  { label: 'work', bold: false, explain: '工作;职业' },
  { label: 'employment', bold: false, explain: '工作' },
  ...
  { label: 'fit', bold: false, explain: '健康的' },
