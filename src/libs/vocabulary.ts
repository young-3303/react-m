...
const vocabularyArray: Vocabulary[] = [
  { label: 'be absorbed in', bold: false, explain: '专注于' },
  { label: 'be immersed in', bold: true, explain: '沉浸在' },
  { label: 'concentrate on', bold: false, explain: '专注于' },
  { label: 'indulge in', bold: true, explain: '沉溺于' },
  { label: 'focus on', bold: false, explain: '' },
  { label: 'keep ones mind on', bold: false, explain: '' },
  { label: 'assimilate', bold: true, explain: '' },
  { label: 'digest', bold: false, explain: '' },
  { label: 'take in', bold: true, explain: '' },
  { label: 'abundant', bold: false, explain: '' },
  { label: 'plentiful', bold: false, explain: '' },
  { label: 'considerable', bold: true, explain: '' },
  { label: 'handsome', bold: true, explain: '' },
  { label: 'numerous', bold: false, explain: '' },
  { label: 'substantial', bold: false, explain: '' },
  { label: 'massive', bold: false, explain: '大量的' },
  { label: 'acceptance', bold: false, explain: '' },
  { label: 'admission', bold: true, explain: '允许进入' },
  { label: 'accomplish', bold: true, explain: '' },
  ...
  { label: 'be applicable to/for', bold: true, explain: '' },
  { label: 'be appropriate for', bold: false, explain: '' },
  { label: 'be suitable for', bold: true, explain: '' },
  ...
  { label: 'alarm', bold: true, explain: '' },
  { label: 'warn', bold: false, explain: '' },
  { label: 'alert', bold: false, explain: '' },
  { label: 'panic', bold: true, explain: '恐慌，惊慌' },
  ...
  { label: 'perceive', bold: true, explain: '认为，理解' },
  ...
  { label: 'anguish', bold: true, explain: '痛苦' },
  { label: 'misery', bold: true, explain: '苦难' },
  { label: 'torment', bold: false, explain: '折磨' },
  { label: 'woe', bold: false, explain: '祸患' },
  { label: 'suffering', bold: true, explain: '' },
  { label: 'pathos', bold: false, explain: '感伤' },
  ...
  { label: 'declare', bold: false, explain: '宣布' },
  { label: 'proclaim', bold: false, explain: '宣布' },
  { label: 'approach', bold: false, explain: '' },
  { label: 'method', bold: false, explain: '' },
  { label: 'means', bold: false, explain: '' },
  { label: 'strategy', bold: false, explain: '战略' },
  ...
  { label: 'kindle', bold: false, explain: '点燃' },
  { label: 'wake up', bold: false, explain: '醒来' },
  { label: 'apparent', bold: true, explain: '明显的' },
  { label: 'obvious', bold: true, explain: '显而易见的' },
  { label: 'evident', bold: false, explain: '明显' },
  ...
  { label: 'oppose', bold: false, explain: '反抗，阻碍' },
  ...
  { label: 'in detail', bold: true, explain: '详细地' },
  { label: 'at the mercy of', bold: true, explain: '可控制范围' },
  { label: 'under the control of', bold: false, explain: '在控制之下' },
  { label: 'attend to', bold: true, explain: '照料，处理' },
  ...
  { label: 'striking', bold: true, explain: '惊人的，异常的' },
